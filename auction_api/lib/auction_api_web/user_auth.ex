defmodule AuctionApiWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      AuctionApiWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule AuctionApiWeb.PageLive do
        use AuctionApiWeb, :live_view

        on_mount {AuctionApiWeb.UserAuth, :mount_current_user}
        ...
      end
